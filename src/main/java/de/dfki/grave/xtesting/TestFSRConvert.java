...
public class TestFSRConvert {
  ...
  public final static String enfold(final String list) {
    ...
    if (listm.matches()) {
      ...
      final String tail = body.substring(index + 1);
  ...
  public static void main(String args[]) {
    System.err.println(convert("12"));
    System.err.println(convert("(13,34)"));
    System.err.println(convert("atomic"));
    System.err.println(convert("'Hello World'"));
    System.err.println(convert("[]"));
    System.err.println(convert("'.'(:(type, event), '.'(:(name,hello),[]))"));
    System.err.println(convert("'.'(:(type, '.'(:(a,b),[])),'.'(:(name,hello),[]))"));
    System.err.println(convert("'.'(:(type,'.'(:(a,'.'(:(msg,'Hello World'),[])),[])),'.'(:(name,hello),[]))"));

    // [type:[a:[msg:'Hello World', a:b]], name:hello, a:b]
    System.err.println(
            convert(
                    "'.'(:(type,'.'(:(a,'.'(:(msg,'Hello World'),'.'(:(a,b),[]))),[])),'.'(:(name,'.'(:(a,b),[])),'.'(:(a,b),'.'(:(a,234),[]))))"));
  }
}
