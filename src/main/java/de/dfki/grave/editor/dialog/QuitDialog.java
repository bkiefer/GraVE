...
public class QuitDialog extends JDialog {
  ...
  //ICONS
  private ImageIcon ICON_EXIT_STANDARD = ResourceLoader.loadImageIcon("img/exit_icon.png");
  private ImageIcon ICON_EXIT_ROLLOVER = ResourceLoader.loadImageIcon("img/exit_icon_blue.png");
  ...
  public QuitDialog(int quitType) {
    ...
    mExitMessage.setIcon(ResourceLoader.loadImageIcon("img/warning_icon.png"));
